 ...
 * 
 * All operations trigger events published to Azure Service Bus.
 */
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> createCustomer(@Valid @RequestBody CreateCustomerRequest request) {
        logger.info("POST /api/v1/customers - Creating customer with email: {}", request.email());
    ...
    public ResponseEntity<CustomerResponse> getCustomer(@PathVariable Integer id) {
        logger.info("GET /api/v1/customers/{} - Retrieving customer", id);
    ...
    public ResponseEntity<Page<CustomerResponse>> getAllCustomers(
        ...
        logger.info("GET /api/v1/customers - Retrieving customers: page={}, size={}, sortBy={}, sortDir={}", 
        ...
        logger.info("Retrieved {} customers from page {}", customers.getNumberOfElements(), page);
    ...
    public ResponseEntity<List<CustomerResponse>> searchCustomers(
        ...
        logger.info("GET /api/v1/customers/search - Searching customers by name: {}", name);
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(
        ...
        logger.info("PUT /api/v1/customers/{} - Updating customer with email: {}", id, request.email());
        
        CustomerResponse customer = customerService.updateCustomer(id, request);
        
        logger.info("Customer updated successfully with id: {}", customer.id());
        return ResponseEntity.ok(customer);
    }
